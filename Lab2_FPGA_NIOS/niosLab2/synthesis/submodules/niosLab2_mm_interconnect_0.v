...
module niosLab2_mm_interconnect_0 (
	...
	wire  [18:0] pio_2_s1_agent_m0_address;                                                          // pio_2_s1_agent:m0_address -> pio_2_s1_translator:uav_address
	...
	wire  [95:0] pio_2_s1_agent_rf_source_data;                                                      // pio_2_s1_agent:rf_source_data -> pio_2_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_2_s1_agent_rsp_fifo_out_data;                                                   // pio_2_s1_agent_rsp_fifo:out_data -> pio_2_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_2_s1_agent:cp_data
	...
	wire  [94:0] pio_2_s1_agent_rp_data;                                                             // pio_2_s1_agent:rp_data -> router_007:sink_data
	...
	niosLab2_mm_interconnect_0_router_003 router_004 (
	...
	niosLab2_mm_interconnect_0_router_002 router_005 (
	...
	niosLab2_mm_interconnect_0_router_002 router_007 (
	...
	niosLab2_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
